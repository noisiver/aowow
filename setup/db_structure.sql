...
CREATE TABLE `aowow_items` (
  ...
  `resHoly` tinyint NOT NULL DEFAULT 0,
  `resFire` tinyint NOT NULL DEFAULT 0,
  `resNature` tinyint NOT NULL DEFAULT 0,
  `resFrost` tinyint NOT NULL DEFAULT 0,
  `resShadow` tinyint NOT NULL DEFAULT 0,
  `resArcane` tinyint NOT NULL DEFAULT 0,
